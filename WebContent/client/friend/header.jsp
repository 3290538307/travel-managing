...
%>  
    ...
    <div class="headWrap">
        ...
        <ul class="dropdown">
            ...
            <li class="current">
                <a href="<%=basePath %>/friend/user_basic.do?id=${param.id }">Ta基本资料</a>
            </li>
            <li>
				<a href="<%=basePath %>/friend/user_memory.do?id=${param.id }">Ta的旅游记忆</a>

			</li>
            <li>
				<a href="<%=basePath %>/friend/user_partner.do?id=${param.id }">Ta的结伴游</a>
			</li>
		</ul>
