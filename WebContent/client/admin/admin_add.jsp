...
<head>
    ...
    <script>
        $(document).ready(function(){
        	$("#adminName").on("blur",function(){
        		$.get("checkadminname.do",{name:$("#adminName").val()},function(data){
        			console.info(data);
                	if("success"==data){
                		$("#chkmsg").html("可以注册").css("color","green");
                	}else{
                		$("#chkmsg").html("管理员名已存在").css("color","red");
                	}
                },"text");		
        	});
        });
    ...
    <script>
        $(document).ready(function(){
        	$("#repass").on("mouseout",function(){
        		$.get("checkadminpwd.do",{password:$("#pass").val(),repassword:$("#repass").val()},function(data){
                	if("success"==data){
			...
			<div class="row-fluid">
				<div class="box span12">
					...
					<div class="box-content">					
					    <form id="myform" runat="server" action="Addadmin.do" method="post">
                        <p>
                            <label>用户名：</label>
							<input type="text" name="user" id="adminName" />
							<span id="chkmsg"></span>
                        </p>
                        <p class="col">
                            <label>密码：</label>
