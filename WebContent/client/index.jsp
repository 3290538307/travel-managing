...
<!-- 合并jquery and $LAB -->
<script type="text/javascript" src="js/jquery-1.4.4.min,LAB.min.js">
</script>
            ...
            <div class="scene-subcnt">
                <ul class="guide-tag">
                	<c:forEach items="${notices }" var="notice">
                		<li><a href="notice/notice.do?id=${notice.id }" class="wantGo">${notice.title }</a></li><br/>
                	</c:forEach>
                </ul>
            </div>
...
<div class="ui-box fn-clear">
    <div class="ui-title">
        ...
        <div class="ui-title-subcnt fn-right"><a target="_blank" href="memory/memory_list.do">+更多</a></div>
    </div>
    <ul class="poi_hot" id="poi_hot">
		<li>
            <a title="惠州罗浮山" href="memory/memory.do">
		...
		<li>
            <a title="西丽水库" href="memory/memory.do">
		...
		<li>
            <a title="婺源" href="memory/memory.do">
		...
		<li>
            <a title="小坑国家森林公园" href="memory/memory.do">
